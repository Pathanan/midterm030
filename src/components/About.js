...
export default function About() {
  return (
    <div className='D'>
      <h1 style ={{textAlign:'center'}}className='H'>About</h1>
                    ...
                    <div className="active tab-pane" id="activity">
                      ...
                      <div className="post">
                        <div className="user-block">
                          ...
                          <h6 className='A'> <span className="description">14:30 PM today</span> </h6>
                        </div>
                        {/* /.user-block */}
                        <p>
                          <img height={290} width={220} src="https://reg.buu.ac.th/registrar/getstudentimage.asp?id=63310030" />
                          
                          <div dir="auto" style={{ textAlign: 'start' }}>ประวัตินิสิต</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>ชื่อ | พัทธนันท์ เจริญคลัง</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>คณะ | วิทยาศาสตร์และศิลปศาสตร์</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>วันเกิด| 18/09/2001</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>มหาวิทยาลัย| มหาวิทยาลัยบูรพาวิทยาเขตจันทบุรี</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>ศาสนา | พุทธ</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>สัญชาติ | ไทย</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>พี่น้อง | 2 คนรวมตัวเองด้วย</div>
                          <div dir="auto" style={{ textAlign: 'start' }}>หมู่เลือด |  O</div>
                        ...
                        <h6 className='C'> <p>
                          ...
                          <span className="float-left">
                            <a href="#" className="link-black text-sm">
                              <i className="far fa-comments mr-1" /> like (950)
                              <i className="far fa-comments mr-1" /> Comments (760)
                            </a>
                          </span>
                        </p> </h6>
                        <input className="form-control form-control-sm" type="text" placeholder="Type a comment" />
